...
namespace SpencerMortensen\Html5\Elements;

use SpencerMortensen\Html5\Element;
use SpencerMortensen\Html5\Text;

class Title extends Element
{
	public function __construct(array $attributes = null, Text $text)
	{
		$name = 'title';
